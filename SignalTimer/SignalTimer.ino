...
SettableInput trigger;
DistanceTimer distanceTimer(trigger);
SettableInput pointInput;
DistanceWithCondition distanceWithCondition(distanceTimer, pointInput);
